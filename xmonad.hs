...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_s     ), spawn "dmenu_run -c -p Execute: ")
...
myStartupHook = do
        spawnOnce "trayer --edge top --align left --margin 1220 --distance 5 --width 10 --height 25 --SetDockType true --tint 0x2e3440 --expand true --padding 5 --transparent true --iconspacing 4"
